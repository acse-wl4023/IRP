...
import numpy as np
from Models.GConvLSTM import GConvLSTM_seq2seq
...
if __name__ == "__main__":
    ...
    # get settings
    with open("/home/wl4023/github_repos/IRP/train_GConvLSTM/GConvLSTM/config.yaml", "r") as file:
        config = yaml.safe_load(file)

    save_path = config['paths']['save_path']
    # save_path = save_path+f"GConvLSTM/"
    ...
    # load model
    model = GConvLSTM_seq2seq(1, 32, 1)
    summary(model, input_data=(train_set[0][0], edge_index, edge_weight, 5))
