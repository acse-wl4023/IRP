...
def train(model, train_set, val_set, test_set, edge_index, edge_weight,
          criterion, metric, metric_test, 
          optimizer, preprocessor, device, scheduler=None, epochs=30, seq_len=5, path_to_save=None):
    ...
    for epoch in range(epochs):
        ...
        for x, y in tqdm(train_set):
            ...
            optimizer.zero_grad()
            predict = model(input, edge_index, edge_weight, seq_len)
